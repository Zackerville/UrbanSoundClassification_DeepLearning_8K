...
def main():
    ...
    metrics_path = evaluation_dir / "resnet18_aug_test_metrics.json"
    report_path = evaluation_dir / "resnet18_aug_classification_report.csv"
    predictions_path = evaluation_dir / "resnet18_aug_test_predictions.csv"
    cm_csv_path = evaluation_dir / "resnet18_aug_confusion_matrix.csv"
    cm_img_path = evaluation_dir / "resnet18_aug_confusion_matrix.png"
    ...
    plot_confusion_matrix(
        ...
        CLASS_NAMES,
        cm_img_path,
        "ResNet18 + Augmentation Confusion Matrix",
    )
